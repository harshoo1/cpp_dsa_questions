...
This is the even version of the Grid Construction Problem. Both are worth 50 points each.

You are given an even integer NN.
...
Test Case 1 : Here, S1=2,S2=4S1​=2,S2​=4. Further, every row and column also adds to 33. Thus, adjacent row(column) sum = 66 = S1+S2S1​+S2​. Hence, this grid is valid.
acceptedAccepted
204
